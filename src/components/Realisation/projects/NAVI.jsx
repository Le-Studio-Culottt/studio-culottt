    ...
    return(
        ...
        <article className="content-realisation">
            ...
            <section>
                ...
                <p>Incorporer un verre de vin à la célèbre cathédrale de Milan était donc de mise. Toute la DA réside dans ce combo typographique de Belles Lettres Italiennes alliées à la fougue d’une police de 'signature', aussi vive que l’équipe.</p>
            </section>
        </article>
        </>
    )
