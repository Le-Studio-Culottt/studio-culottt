    ...
    return(
        ...
        <article className="content-realisation">
            ...
            <section>
                ...
                <p>Avec ces outils, j'ai créé la palette des blancs cassés et gris chauds utilisés, couplés avec des gris sombre sans aller jusqu'au noir. Pourquoi ? Pour que le contraste soit lisible mais pas agressif et qu'on lise le plus longtemps possible sans avoir mal aux yeux !</p>
                <p>Avec cet effet un peu 'papier' naturel vient s'agrémenté le rouge Bordeaux du logo de Ni bu ni connu. Un petit clin d'œil au vin tout en étant discret.</p>
            </section>
        </article>
        </>
    )
