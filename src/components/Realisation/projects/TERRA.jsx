    ...
    return(
        ...
        <article className="content-realisation">
            ...
            <section>
                ...
                <p>Terra Vine possède une palette de compétence importante et nous sommes les seuls qui peuvent interagir sur le déploiement de ces cinq piliers : Public Relations, SEO, Pay Per Click, Social Marketing et Brand Management.</p>
            </section>
        </article>
        </>
    )
