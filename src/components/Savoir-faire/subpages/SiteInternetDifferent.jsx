    ...
    return(
        <>  
            <main className={windowSize.innerWidth <= 1201 ? "subs" : "subs desk"}>
                ...
                <br />Le site internet est le meilleur moyen de communiquer toutes ces informations au consommateur final. Dans des métiers du secteur du vin, un cépage ou un procédé de fabrication peut paraître évident. Même notre caviste préféré peut nous renseigner un maximum sur tout les détails, ton histoire et tes coordonnées.
                ...
                <p>En plus de présenter tes produits et qui tu es, le web sert à créer un lien avec les consommateurs. Il sert aussi a te valoriser toi et tes produits, avec des clichés et une communication représentative, le but est d’avoir des visuels de qualité.<br />Un site internet sert à servir un ou plusieurs objectifs. C’est l’outil marketing central car il va regrouper énormement d’informations. Mais le plus simple est souvent le meilleur. Rien de trop compliqué pour ne perdre personne et hiérarchiser les informations, les adaptés, c’est notre rôle !<br />C’est aussi l’occasion de traduire tout ces contenus en anglais et même en d’autres langues pour l’export.</p>

                <h2 id="anchor-site">Site internet, site vitrine et site e-commerce</h2>
                <p>Les sites internet peuvent être catégorisés de deux manière ; les site vitrine qui servent à divulguer de l’information à nos internautes, en allant jusqu’au blog. Puis les site e-comm</p>
